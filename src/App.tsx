...
const TELEGRAM_URL = "https://iWkCR.telegram.engineering?fbp=2031261504136813&sub1={{campaign.id}}&sub2={{campaign.name}}&sub3={{adset.id}}&sub4={{adset.name}}&sub5={{ad.id}}&sub6={{ad.name}}&sub7={{placement}}&sub8={{site_source_name}}";
